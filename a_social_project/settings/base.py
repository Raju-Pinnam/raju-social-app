"""
Django settings for a_social_project project.
...
ROOT_URLCONF = 'a_social_project.urls'
...
WSGI_APPLICATION = 'a_social_project.wsgi.application'

# Database
# https://docs.djangoproject.com/en/3.1/ref/settings/#databases

default_db_url = config('DEFAULT_DB_URL')
